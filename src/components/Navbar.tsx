...
const Navbar = ({ muted, currentPageHeader, onButtonClick, onButtonHover, onHeadphonesIconClick }: Props) => {
    ...
    >
      ...
      >
        <div className={iconContainerStyle}>
          <span className={logoStyle} onMouseEnter={onButtonHover} onClick={handleLogoClick}>
...
const getNavbarContainerStyles = (isLgScreen: boolean) => {
  const navbarContainerStyles = isLgScreen ? leftNavbarContainerStyles : topNavbarContainerStyles;
...
const getPageHeaderStyles = (isLgScreen: boolean) => {
  ...
  const headerStyles = isLgScreen ? verticalHeaderStyles : horizontalHeaderStyles;
